...
--IF dbo.CronValidate('55-5 * * * *', '00:55') = 1 SET @Count += 1 ELSE SET @ErrMsg = '55-5 * * * * 00:55';
--IF dbo.CronValidate('55-5 * * * *', '00:59') = 1 SET @Count += 1 ELSE SET @ErrMsg = '55-5 * * * * 00:59';
--IF dbo.CronValidate('55-5 * * * *', '00:00') = 1 SET @Count += 1 ELSE SET @ErrMsg = '55-5 * * * * 00:00';
--IF dbo.CronValidate('55-5 * * * *', '00:03') = 1 SET @Count += 1 ELSE SET @ErrMsg = '55-5 * * * * 00:03';
--IF dbo.CronValidate('55-5 * * * *', '00:05') = 1 SET @Count += 1 ELSE SET @ErrMsg = '55-5 * * * * 00:05';
